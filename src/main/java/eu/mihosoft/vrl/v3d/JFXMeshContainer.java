...
public class JFXMeshContainer {
    ...
    JFXMeshContainer(Vector3d min, Vector3d max, Mesh... meshes) {
        this(min, max, Arrays.asList(meshes));
    }

    JFXMeshContainer(Vector3d min, Vector3d max, List<Mesh> meshes) {
        this.meshes = meshes;
    ...
    JFXMeshContainer(Vector3d min, Vector3d max, List<Mesh> meshes, List<Material> materials) {
        this.meshes = meshes;
...
//    }
//
//    private void setMeshScale(JFXMeshContainer meshContainer, javafx.geometry.Bounds t1, final Group meshView) {
//        double maxDim
